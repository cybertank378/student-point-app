...
import type { useAcademicYearApi } from "@/modules/academic-year/presentation/hooks/useAcademicYearApi";
        ...
        <tbody>
          {academicYears.map((item) => (
            <TableRow key={item.id}>
              ...
              <TableCell>{dateFormater(item.startDate)}</TableCell>

              <TableCell>{dateFormater(item.endDate)}</TableCell>
              ...
              <TableCell>
                <Switch
                  ...
                  disabled={loadingId === item.id || item.isActive}
                  onChange={() => handleSetActive(item.id, item.isActive)}
                />
              </TableCell>
