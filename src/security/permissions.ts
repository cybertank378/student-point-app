//Files: src/security/permissions.ts
export const PERMISSIONS = {
  ...
  VIOLATION_APPEAL_READ: "violation_appeal.read",
  VIOLATION_APPEAL_CREATE: "violation_appeal.create",
  VIOLATION_APPEAL_MANAGE: "violation_appeal.manage",
