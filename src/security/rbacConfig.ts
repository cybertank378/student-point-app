//Files: src/security/rbacConfig.ts
// ============================================================
// FILE: rbacConfig.ts
// PURPOSE:
...
import { PERMISSIONS, type Permission } from "@/security/permissions";
...
export const roleConfig: Record<Role, { icon: IconType; colorClass: string; label: string }> = {
  ADMIN: {
    icon: FiShield,
...
export const rbacConfig = {
  ...
  roles: {
    ...
    STUDENT: [
      ...
      PERMISSIONS.WARNING_LETTER_READ,
      PERMISSIONS.VIOLATION_APPEAL_CREATE,
      PERMISSIONS.VIOLATION_APPEAL_READ,
    ],

    PARENT: [PERMISSIONS.DASHBOARD_VIEW, PERMISSIONS.STUDENT_READ, PERMISSIONS.VIOLATION_READ],
  } as Record<Role, "ALL" | Permission[]>,
  ...
  api: {
    ...
    "/api/students": {
      ...
      PATCH: PERMISSIONS.STUDENT_MANAGE,
  ...
  sidebar: [
...

    {
      ...
      roles: ["ADMIN", "TEACHER"],
      teacherRoles: ["COUNSELOR", "DUTY_TEACHER"],
      children: [
        {
...

    {
      ...
      icon: MdEmojiEvents,
      roles: ["TEACHER"],
      teacherRoles: ["SUBJECT_TEACHER", "HOMEROOM"],
      children: [
        {
...

    {
      ...
      icon: MdAssignmentTurnedIn,
      roles: ["TEACHER"],
      teacherRoles: ["SUBJECT_TEACHER", "HOMEROOM", "DUTY_TEACHER"],
      children: [
        {
...

    {
      ...
      children: [
        ...
        },
        {
          ...
          path: "/dashboard/violations/detail",
          permission: PERMISSIONS.VIOLATION_READ,
        },
      ],
    },
...

    {
      ...
      children: [
        ...
        },
        {
          ...
          path: "/dashboard/achievements/history",
          permission: PERMISSIONS.ACHIEVEMENT_READ,
        },
      ],
    },
...

    {
      ...
      children: [
        ...
        {
          label: "Jadwal Konseling",
          path: "/dashboard/counseling/schedule",
          permission: PERMISSIONS.COUNSELING_READ,
        },
      ],
    },
    ...
    {
      label: "Klarifikasi Pelanggaran",
      icon: MdReportProblem,
      roles: ["STUDENT"],
      children: [
        {
          label: "Ajukan Klarifikasi",
          path: "/dashboard/violation-appeals/create",
          permission: PERMISSIONS.VIOLATION_APPEAL_CREATE,
        },
        {
          label: "Riwayat Klarifikasi",
          path: "/dashboard/violation-appeals",
          permission: PERMISSIONS.VIOLATION_APPEAL_READ,
        },
      ],
    },
...

    {
      ...
      children: [
        ...
        },
        {
          ...
          path: "/dashboard/rules/categories",
          permission: PERMISSIONS.VIOLATION_READ,
        },
      ],
    },
...
export function getAvatarMenuByRole(role: Role): AvatarMenuNode[] {
