...
export class AcademicYearService {
  ...
  constructor(repo: AcademicYearInterface) {
   ...
   * =========================
   */
  async getById(id: string): Promise<Result<AcademicYear>> {
   ...
   * =========================
   */
  async create(dto: CreateAcademicYearDTO): Promise<Result<AcademicYear>> {
   ...
   * =========================
   */
  async update(dto: UpdateAcademicYearDTO): Promise<Result<AcademicYear>> {
