...
async function main() {
    ...
    await prisma.$transaction(async (tx) => {
        ...
        //////////////////////////////////////////////////////
        // ACHIEVEMENT MASTER (FIXED → UPSERT)
        //////////////////////////////////////////////////////
        ...
        for (let family = 1; family <= 15; family++) {
            const fatherPhone = `0812300${family}`;
            const motherPhone = `0821300${family}`;
